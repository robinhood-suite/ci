...
runci()
{
    ...
    *)
    ...
    jq -n '{
        "message": "Beep Bop, I'"'"'m a bot.",
        "tag": "autogenerated:gcc-bot",
        "labels": {"Verified": '"$score"'},
        "robot_comments": (inputs // {}),
        "notify": "'"$notify"'",
        "omit_duplicate_comment": true
        }' robot-comments.json |
            gerrit review --json --project "$project" "$commit"
}
